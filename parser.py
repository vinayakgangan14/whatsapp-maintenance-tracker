...
def parse_whatsapp_message(text, sender_phone="", sender_name=""):
    ...
    # Matches: "2 Press 3 Fixed", "FIX Machine 2 - Replaced seal", "Machine 2 fixed", "Fixed Press 3"
    ...
    # Matches: "3 Air Compressor Filter change", "MAINT Pump 1 oil change", "Service Press 3"
    ...
    # 6. BREAKDOWN REPORT (Shortcut: 1 <Equipment> <Issue> or "Down <Equipment>" or "Machine 2 not working")
